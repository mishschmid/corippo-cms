import{j as e,l as b,a1 as p,eY as O,a as A,f as x,T as k,k as Ce,r as R,aL as L,I as U,g as we,a8 as Te,fy as $e,bX as Q,b9 as V,a5 as ee,fz as ve,h as te,bD as ke,bK as De,bL as Me,cY as Re,bo as Fe,b as ne,aI as Se,s as Ae,bM as oe,H as B,da as Ie,X as Ee,B as Le,fg as Oe,bq as Ne,aR as X,fA as Ue,E as ie}from"./strapi-CAJIOWBD.js";import{u as D,g as m,C as Y,a as W,A as Be,S as Pe,c as _}from"./index-tfWD0EWp.js";import{d as ze,e as J,D as Ze,f as Ve,a as We,S as He,v as Ge,s as Ke,K as qe,P as Xe,c as Ye,C as _e}from"./sortable.esm-CiOveRZM.js";import"./index-B2RAUf1V.js";import"./groupBy-C0wt-7eo.js";import"./_baseEach-B15rDIzy.js";import"./sortBy-07DWeET1.js";import"./_baseMap-BkGdO2c4.js";import"./index-CgNnaOxo.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";const Je=t=>{let{transform:n}=t;return{...n,x:0}},Qe=b(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,wt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=A(),s=Ee(),a=yt(n),l=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const y=jt(n);return s(y),!1},{isLoading:c,allowedActions:f}=Le(a);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(Ct,{startIcon:e.jsx(Oe,{}),variant:"tertiary",onClick:i,disabled:t,children:l})}),Tt=b(ie.Header)`
  ...
  white-space: nowrap;
`,Lt=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=D(),{formatMessage:a}=A(),{trackUsage:l}=ne(),{contentTypeUid:i,componentUid:c}=Ne(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:y,onOpenModalEditSchema:v}=W(),r=i?n[i]:c?o[c]:null;if(s)return null;if(!r){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(X,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(X,{to:"/plugins/content-type-builder/content-types/create-content-type"})}const d="plugin"in r&&r?.plugin!==void 0,u=i?"contentType":"component",w=r?.info?.displayName??"",T=t&&!d,F=j=>{f({dynamicZoneTarget:j,targetUid:r.uid})},M=()=>{if("kind"in r){r?.kind==="collectionType"&&l("willEditNameOfContentType"),r?.kind==="singleType"&&l("willEditNameOfSingleType"),v({modalType:u,forTarget:u,targetUid:r.uid,kind:r?.kind});return}v({modalType:u,forTarget:u,targetUid:r.uid})},I=a({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),S=a({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=r.status==="REMOVED",h=t&&e.jsxs(x,{gap:2,children:[e.jsx(wt,{type:r,disabled:r.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(B,{startIcon:e.jsx(te,{}),variant:"tertiary",onClick:M,disabled:!T||g,children:a({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(B,{startIcon:e.jsx(L,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{y({forTarget:u,targetUid:r.uid})},disabled:g,children:r.attributes.length===0?I:S})]});return e.jsxs(e.Fragment,{children:[e.jsx(oe.contentTypeBuilder.Introduction,{children:e.jsx(p,{})}),g&&e.jsx(x,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(x,{gap:2,children:[e.jsx(Ue,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx(k,{children:a({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:r.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(Tt,{id:"title",primaryAction:h,title:V(w)}),e.jsx(ie.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(ue,{type:r,addComponentToDZ:F,isMain:!0})})})]})};export{Lt as default};
